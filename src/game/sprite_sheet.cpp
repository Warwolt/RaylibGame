...
std::optional<SpriteSheetID> SpriteSheetManager::load_aseprite_sprite_sheet(ResourceManager* resources, const std::string& image_path, const std::string& json_path) {
	/* Load sprite sheet image */
	std::optional<ImageID> image = resources->load_image(image_path);
	if (!image.has_value()) {
...
const SpriteSheet& SpriteSheetManager::get_sprite_sheet(SpriteSheetID sprite_sheet_id) const {
